...
text_cleaner = TextCleaningComposer(cleaner_names=["EmoticonRemover", "UsernameRemover"])

dataloader_train = DataLoader(data_type="train", text_cleaner=text_cleaner, batch_size=32, max_seq_len=64)
dataloader_valid = DataLoader(data_type="valid", text_cleaner=text_cleaner, batch_size=32, max_seq_len=64)
